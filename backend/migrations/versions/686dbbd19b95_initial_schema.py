...
def upgrade():
    ...
    op.create_table('accounts',
        sa.Column('account_id', mysql.INTEGER(), nullable=False),
    ...
    op.create_table('auditlog',
        sa.Column('audit_log_event_id', mysql.INTEGER(unsigned=True), nullable=False),
    ...
    op.create_table('emails',
        sa.Column('email_id', mysql.INTEGER(), nullable=False),
    ...
    op.create_table('issue_properties',
        sa.Column('property_id', mysql.INTEGER(unsigned=True), nullable=False),
    ...
    op.create_table('issue_types',
        sa.Column('issue_type_id', mysql.INTEGER(unsigned=True), nullable=False),
    ...
    op.create_table('logs',
        sa.Column('log_event_id', mysql.INTEGER(), nullable=False),
    ...
    op.create_table('resource_types',
        sa.Column('resource_type_id', mysql.INTEGER(unsigned=True), nullable=False),
    ...
    op.create_table('tags',
        sa.Column('tag_id', mysql.INTEGER(), nullable=False),
        sa.Column('resource_id', sa.String(length=256), nullable=False),
    ...
    op.create_table('config_items',
        sa.Column('config_item_id', mysql.INTEGER(), nullable=False),
    ...
    op.create_table('user_roles',
        sa.Column('user_role_id', mysql.INTEGER(), nullable=False),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_resource_mappings_parent'), table_name='resource_mappings')
    op.drop_index(op.f('ix_resource_mappings_child'), table_name='resource_mappings')
